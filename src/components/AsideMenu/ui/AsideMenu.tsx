...
export const AsideMenu = () => {
  return (
    <aside className="w-65 h-screen bg-white">
        ...
        {MAIN_MENU_ITEMS.map((item) => {
          ...
          return (
            <li key={item.alias}>
              <a
                href={item.href}
                className={`py-[9px] px-4 text-sm flex items-center gap-2 rounded-md transition-colors ease-in-out duration-100 ${
                  isActive
      ...
      <div className="py-[15px] px-[30px] mt-2">
        ...
        {PRODUCTS_MENU_ITEMS.map((item) => {
          ...
          return (
            <li key={item.alias}>
              <a
                href={item.href}
                className="py-[9px] px-4 text-sm flex items-center gap-2 rounded-md text-[#8B909A] transition-colors ease-in-out duration-100 hover:bg-gray-200 hover:text-[#23272E]"
              >
                <Icon className="size-5" />
                {item.alias}
              </a>
