...
Vendored from [conventional-changelog/conventional-changelog — skills/conventional-commit-message](https://github.com/conventional-changelog/conventional-changelog/tree/master/skills/conventional-commit-message) (MIT, author: dangreen). Read when choosing a commit type, breaking-change marker, scope, or validating messages with commitlint.

## House overrides

This skill's base format is the one-liner below; these rules override anything in the upstream base:
...
- **Gitmoji prefix optional** — see [gitmoji](../gitmoji/SKILL.md)

---

# Conventional Commit Message (upstream)
